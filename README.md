...
![](https://i.imgur.com/WlbFFea.png)
- Select **Time** from the dropdown that appears  
![](https://i.imgur.com/1GxxOO6.png)
...
![](https://i.imgur.com/JB6CCS1.png)
- From the **Action Category** list pick **Net** (1) then **HTTP Request** (1)  
![](https://i.imgur.com/x8BuVij.png) ![](https://i.imgur.com/RXWzxki.png)
